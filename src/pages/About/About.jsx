  ...
  render() {
    return (
      <div>
        ...
        <section className="ftco-section testimony-section ftco-degree-bg">
          <div className="container">
            <div className="row justify-content-center mb-5 pb-5">
              ...
              <div className="col-md-12">
                <div className="carousel-testimony owl-carousel ftco-owl owl-loaded owl-drag">
                  <div className="owl-stage-outer">
                    <div className="owl-stage about-stage">
                      <div className="owl-item cloned about-cloned">
                        <div className="item text-center">
                          <div className="testimony-wrap p-4 pb-5">
                            <div className="user-img mb-4 about-person">
                      ...
                      <div className="owl-item active center about-cloned">
                        <div className="item text-center">
                          <div className="testimony-wrap p-4 pb-5">
                            <div className="user-img mb-4 about-person">
                              <span className="quote d-flex align-items-center justify-content-center">
                      ...
                      <div className="owl-item about-cloned">
                        <div className="item text-center">
                          <div className="testimony-wrap p-4 pb-5">
                            <div className="user-img mb-4 about-person">
                              <span className="quote d-flex align-items-center justify-content-center">
